@extends("layouts.web")
@section("style")
    <link rel="stylesheet" href="{{ asset('assets/web/css/pages/article-detail.min.css') }}">
@endsection
@section("content")
            ...
            <div class="row g-5">
                        ...
                        <div class="article-meta">
                            ...
                            <p class="article-category">
                                <i class="bi bi-stack"></i><a
                                    href="{{ route('article.category', ['category' => $record->category?->getTranslatedAttribute('slug')]) }}">{{ $record->category?->getTranslatedAttribute('name') }}</a>
                            </p>
                ...
                <div class="col-md-3">
                    <div class="article-sidebar position-sticky" style="top: 2rem;">
                        <div class="article-author p-4 mb-3 bg-body-tertiary rounded">
