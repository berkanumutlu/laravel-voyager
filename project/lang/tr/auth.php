...
return [
    ...
    */
    ...
    'user_update_profile'     => "{error} Bilgileriniz kaydedilemedi.|{success} Bilgileriniz başarıyla güncellendi.",
    'user_change_password'    => "{error} Şifre değiştirilirken bir hata oluştu.|{success} Şifreniz başarıyla değiştirildi.",
    'current_password_failed' => "Mevcut şifreniz yanlış.",
];
