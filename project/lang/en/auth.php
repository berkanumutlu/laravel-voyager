...
return [
    ...
    */
    ...
    'user_update_profile'     => "{error} Your information could not be saved.|{success} Your information has been updated successfully.",
    'user_change_password'    => "{error} Your password could not be saved.|{success} Your password has been updated successfully.",
    'current_password_failed' => "Your current password is not correct.",
];
